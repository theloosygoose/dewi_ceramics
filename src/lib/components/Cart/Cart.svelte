...
{#if isCartOpen}
    <div 
    in:slide="{{duration:1000, easing: backOut}}" out:slide="{{duration:600, easing:expoOut}}"
    class="z-10 bg-tan h-fit w-full md:w-1/2 lg:w-1/3 fixed right-0 overflow-hidden drop-shadow-xl
