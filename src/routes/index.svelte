...
<div class="z-[1] relative bg-mywork-mobile-img bg-[center] bg-no-repeat bg-cover w-full h-[80vh] flex items-end justify-left overflow-hidden">
    {#if ready}
        <div class="relative z-0 ml-[5%] mb-[10%] w-1/2"
